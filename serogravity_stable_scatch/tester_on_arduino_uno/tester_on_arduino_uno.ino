...
void loop(){
  ...
  //расстояние = d2/10 = мм
  //время = d1 = сек
  //скорость = d2/d1 = мм/сек

  //расстояние в шагах = (d2/10)*0.785 = шагов
  //скороть в шагах = ((d2/10)*0.785)/d1
  //Serial.println(int(d1));
  //Serial.println(int(d2));
  
  //Serial.println(int(d1/((d2*10)*0.785)));
  //Serial.println(int((d2*10)*0.785));
  
  stepper1.setMaxSpeed(d1);
  stepper1.setAcceleration(6000);
  stepper1.moveTo(d2*52);
  stepper2.setMaxSpeed(d3);
  stepper2.setAcceleration(6000);
  stepper2.moveTo(d4*52);
  stepper3.setMaxSpeed(d5);
  stepper3.setAcceleration(6000);
  stepper3.moveTo(d6*52);
  stepper4.setMaxSpeed(d7);
  stepper4.setAcceleration(6000);
  stepper4.moveTo(d8*52);
  stepper5.setMaxSpeed(d9);
  stepper5.setAcceleration(6000);
  stepper5.moveTo(d10*52);
  stepper6.setMaxSpeed(d11);
  stepper6.setAcceleration(6000);
  stepper6.moveTo(d12*52);
